...
![Translucent water droplet with a tiny scuba diver swimming inside](/writing/liquid-glass/liquid-water.png "Liquid water: the beginning.")
...
![Soft white cloud with a hang glider soaring beside it against a misty sky](/writing/liquid-glass/gaseous-state.png "Water in a gaseous state is a new dimension to a design system.")
...
![Melting ice cube scaled as a mountain with a tiny climber on its face](/writing/liquid-glass/solid-ice.png "Ice, freezing components in a new state.")
