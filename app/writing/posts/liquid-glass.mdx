...
image: '/writing/liquid-glass/liquid-water.png'
medium: 'https://medium.com/design-bootcamp/liquid-glass-has-reignited-ideas-that-never-quite-disappeared-eca658d00853'
---

![Translucent water droplet with a tiny scuba diver swimming inside](/writing/liquid-glass/liquid-water.png#wide "Liquid water: the beginning.")
...
![iPhone music app with a frosted-glass mini player and a translucent tab bar](/writing/liquid-glass/liquid-glass-components.png "Liquid Glass Components.")
...
![Apple TV, MacBook, iPad, iPhone and Apple Watch showing Liquid Glass interfaces](/writing/liquid-glass/apple-liquid-glass.png "Apple’s Latest: Liquid Glass")
...
![Collage of Material Design graphics including overlapping planes, illustration, and a calculator UI](/writing/liquid-glass/material-design.png "Material Design by Google.")
...
![Soft white cloud with a hang glider soaring beside it against a misty sky](/writing/liquid-glass/gaseous-state.png#wide "Water in a gaseous state is a new dimension to a design system.")
...
![Melting ice cube scaled as a mountain with a tiny climber on its face](/writing/liquid-glass/solid-ice.png#wide "Ice, freezing components in a new state.")
