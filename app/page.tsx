...
const sectionHeadingClassName =
  'mb-6 font-mono text-xs font-normal uppercase tracking-wider text-neutral-500 dark:text-neutral-400'
  ...
  return (
    <>
      <header className="mb-16">
        ...
        <div className="mt-16 space-y-6 leading-relaxed text-neutral-800 dark:text-neutral-200">
          <p>
            {`Based in Mendoza, Argentina, with years of experience in SaaS and
            AI-driven products for global teams, I collaborate closely with
            product and engineering to design experiences that support product
