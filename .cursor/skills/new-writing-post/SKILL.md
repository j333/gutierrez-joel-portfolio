...
description: Publish a new notes article as MDX with a 1920×1080 WebP cover. Use when adding a notes post, blog article, or MDX in app/notes/posts.
---
...
`medium` is optional. If set, Medium’s canonical URL should be this site’s `/notes/<slug>`.
